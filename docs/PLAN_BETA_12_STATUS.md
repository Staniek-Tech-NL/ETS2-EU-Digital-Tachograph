...
| **M5** | Lokalizacja PL/EN | 🟡 M5.1; paczki 1–4 GO | W TOKU | M6 |
...
- **Stan:** M5.1 — inwentaryzacja tekstów, kontraktów i ryzyk przepełnień;
  paczki 1–4 zamknięte wynikiem GO.
...
- **Paczka 4:** Historia, luki i wpis manualny — 87 wiążących kluczy,
  0 pozycji otwartych.
- **Katalog łączny:** 257 kluczy, 257 unikalnych nazw; jawna lista
...
- **X-01:** wspólne formatery czasu i terminów — obszar do rozpisania;
  warunek kompletności Dashboardu i listy dni w modalu wpisu manualnego oraz
  wspólne wejście dla Planera, Raportów i `WeeklyRestWindowFormatter`.
- **Pozostałe obszary M5.1:** `X-01`, `UI-04`, `UI-05`, `UI-06`, `UI-07`,
  `UI-08`, `UI-09`, `UI-10` i `PDF-01`; `DOC-01/02` pozostają odłożone
  do M5.4.
